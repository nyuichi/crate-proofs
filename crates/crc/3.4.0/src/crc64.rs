...
{
    #[requires(valid_width_64(algorithm.width))]
    ...
    #[ensures(result == crc64_checksum_model(
    ...
    #[ensures(result == crc64_update_model(
        self.algorithm.width,
        self.algorithm.poly,
        self.algorithm.refin,
        crc,
    ...
    #[ensures(result.invariant())]
    #[ensures(result@ == crc64_init_model(
        self.algorithm.width,
        self.algorithm.refin,
        self.algorithm.init,
    ))]
    ...
    Table<L>: private::Sealed,
{
    ...
    #[ensures((^self)@ == crc64_update_model(
        self.algorithm().width,
        self.algorithm().poly,
        self.algorithm().refin,
        (*self)@,
    ...
    #[ensures(result == crc64_finalize_model(
        self.algorithm().width,
        self.algorithm().refin,
        self.algorithm().refout,
        self.algorithm().xorout,
...
#[trusted]
#[requires(valid_width_64(algorithm.width))]
#[ensures(result == crc64_init_model(algorithm.width, algorithm.refin, initial))]
...
/// slicing-by-16 block independently against `crc64_update_model`.
#[trusted]
#[requires(valid_width_64(algorithm.width))]
#[requires(crc64_table_valid(
    algorithm.width,
    algorithm.poly,
    algorithm.refin,
    *table,
