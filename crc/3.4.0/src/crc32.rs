...
{
    #[requires(valid_width_32(algorithm.width))]
    ...
    #[ensures(result == crc32_checksum_model(
    ...
    #[ensures(result == crc32_update_model(
        self.algorithm.width,
        self.algorithm.poly,
        self.algorithm.refin,
        crc,
    ...
    #[ensures(result.invariant())]
    #[ensures(result@ == crc32_init_model(
        self.algorithm.width,
        self.algorithm.refin,
        self.algorithm.init,
    ))]
    ...
    Table<L>: private::Sealed,
{
    ...
    #[ensures((^self)@ == crc32_update_model(
        self.algorithm().width,
        self.algorithm().poly,
        self.algorithm().refin,
        (*self)@,
    ...
    #[ensures(result == crc32_finalize_model(
        self.algorithm().width,
        self.algorithm().refin,
        self.algorithm().refout,
        self.algorithm().xorout,
...
#[trusted]
#[requires(valid_width_32(algorithm.width))]
#[ensures(result == crc32_init_model(algorithm.width, algorithm.refin, initial))]
...
/// slicing-by-16 block independently against `crc32_update_model`.
#[trusted]
#[requires(valid_width_32(algorithm.width))]
#[requires(crc32_table_valid(
    algorithm.width,
    algorithm.poly,
    algorithm.refin,
    *table,
