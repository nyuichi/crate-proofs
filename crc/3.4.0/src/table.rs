...
/// Trusted table-generation boundary. TODO: prove both generation loops from
/// the lane recurrence in `crc8_table_valid`.
#[trusted]
#[requires(valid_width_8(width))]
#[ensures(crc8_table_valid(width, poly, reflect, result))]
...
/// Trusted table-generation boundary. TODO: prove both generation loops from
/// the lane recurrence in `crc16_table_valid`.
#[trusted]
#[requires(valid_width_16(width))]
#[ensures(crc16_table_valid(width, poly, reflect, result))]
...
/// Trusted table-generation boundary. TODO: prove both generation loops from
/// the lane recurrence in `crc32_table_valid`.
#[trusted]
#[requires(valid_width_32(width))]
#[ensures(crc32_table_valid(width, poly, reflect, result))]
...
/// Trusted table-generation boundary. TODO: prove both generation loops from
/// the lane recurrence in `crc64_table_valid`.
#[trusted]
#[requires(valid_width_64(width))]
#[ensures(crc64_table_valid(width, poly, reflect, result))]
...
/// Trusted table-generation boundary. TODO: prove both generation loops from
/// the lane recurrence in `crc128_table_valid`.
#[trusted]
#[requires(valid_width_128(width))]
#[ensures(crc128_table_valid(width, poly, reflect, result))]
